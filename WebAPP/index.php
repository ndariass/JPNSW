...
<div class="navbar-fixed">
    ...
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo"></a>
      <ul class="right hide-on-med-and-down">
        <li><a href="index.php.php">Inicio</a></li>
  ...
  <div class="container">
    <div class="row">
     ...
     <iframe width="100%" height="315" src="https://www.youtube.com/embed/5s4MxySCi0w?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>

    </div>
    <div class="row center">
    <a href="inicio.php" id="download-button" class="btn-large waves-effect waves-light green-button btn-big-text">Continuar</a>
    </div>  
  </div>
