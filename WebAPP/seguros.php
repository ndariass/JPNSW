    ...
    <div class="row">
      ...
      <a class="black-text" href="#">
        <div class="icon-block">
          ...
          <h5 class="center">Seguro de vida</h5>
      ...
      <a class="black-text" href="#">
        <div class="icon-block">
          ...
          <h5 class="center">Seguro financiero</h5>
